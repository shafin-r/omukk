...
export default function NavBar() {
  ...
  return (
    <motion.div
      ...
      animate="enter"
      exit="exit"
      className="h-screen bg-[#313131] fixed lg:-right-16 right-0 top-0 lg:-top-5 text-white -z-10 "
    >
      ...
      <div className="box-border h-screen lg:pr-60 lg:pt-20 lg:pb-10 lg:pl-20 pr-12 pl-10 pb-20 pt-24 flex flex-col justify-between ">
        <div
          onMouseLeave={() => {
            setSelectedIndicator(window.location.pathname);
          }}
