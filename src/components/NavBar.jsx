...
export default function NavBar() {
  ...
  const padding = width > 400 ? "px-14" : "px-7"
  return (
    <motion.div
      variants={menuSlide}
      initial="initial"
      animate="enter"
      exit="exit"
      className="h-screen bg-[#313131] fixed right-0 top-0 lg:-right-20 lg:-top-5 text-white -z-10"
    >
      <div className="fixed left-20 -top-40 -z-40 w-[500px] h-[500px] bg-[#5a5a5a] rounded-full"></div>
      <div className="fixed left-40 -top-20 -z-50 w-[500px] h-[500px] bg-[#b1b1b1] rounded-full"></div>
      <div className={`box-border py-20 h-screen flex flex-col justify-between ${padding}`}>
        <div
          onMouseLeave={() => {
            setSelectedIndicator(window.location.pathname);
          }}
